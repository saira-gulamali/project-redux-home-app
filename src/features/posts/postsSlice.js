...
const initialState = postsAdapter.getInitialState({
  status: postStatusIndex.idle, //'idle' | 'loading' | 'succeeded' | 'failed'
  error: null,
  count: 0,
});
  ...
  extraReducers(builder) {
    builder
      .addCase(fetchPosts.pending, (state, action) => {
        state.status = postStatusIndex.loading;
      })
      .addCase(fetchPosts.fulfilled, (state, action) => {
        state.status = postStatusIndex.succeeded;
